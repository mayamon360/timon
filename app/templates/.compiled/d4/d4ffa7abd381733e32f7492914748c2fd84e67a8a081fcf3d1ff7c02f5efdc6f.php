...
/* compra/compra.twig */
class __TwigTemplate_f41909a3a57fcf15d35d204a569f7148a84a1c54d7794b66aba5a0c4ab5cdb75 extends Twig_Template
{
...
\t\t\t\t";
        ...
        if ((($context["error_get"] ?? null) == "cambio_stock")) {
            // line 38
            echo "            <div class=\"alert alert-warning p-2 mb-0 text-center animated flash\" role=\"alert\" style=\"font-size:11px!important;\">
                <p class=\"mb-0 pb-0\"><strong>¡ATENCIÓN!</strong> Hubo cambios en su lista de compra, por favor revise antes de continuar con su compra.</p>
            </div>
        ";
        }
        // line 42
        ...
        <div class=\"text-right d-block d-lg-none mt-3 div_procesar_compra\"></div>
...
";
    ...
    {
        return array (  126 => 80,  123 => 79,  84 => 42,  78 => 38,  76 => 37,  66 => 29,  54 => 15,  51 => 14,  42 => 8,  39 => 7,  34 => 4,  31 => 3,  11 => 1,);
    }
...
\t\t\t\t<div class=\"my-1 animated fadeIn separador separador_color\"></div>
\t\t\t\t
\t\t\t\t{#<button type=\"button\" class=\"btn btn-sm btn-icon d-none btn-link text-app px-0 limpiar_carrito\">
\t\t\t\t    <span class=\"btn-inner--icon\"><i class=\"fas fa-trash-alt\"></i></span>
                    <span class=\"btn-inner--text\">Vaciar lista de compra</span>
                </button>#}
            </div>
        ...
        {% if error_get == 'cambio_stock' %}
            <div class=\"alert alert-warning p-2 mb-0 text-center animated flash\" role=\"alert\" style=\"font-size:11px!important;\">
                <p class=\"mb-0 pb-0\"><strong>¡ATENCIÓN!</strong> Hubo cambios en su lista de compra, por favor revise antes de continuar con su compra.</p>
            </div>
        {% endif %}
...
\t<script src=\"assets/jscontrollers/compra/compra.js\"></script>
{% endblock %}", "compra/compra.twig", "/home4/eltimonl/public_html/app/templates/compra/compra.twig");
    }
}
