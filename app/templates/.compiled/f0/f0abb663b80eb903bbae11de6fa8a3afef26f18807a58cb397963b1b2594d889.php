...
class __TwigTemplate_e965c1892808ab753e6671ba18c41a65dfad281a102addb23e927bba7f803bf1 extends Twig_Template
{
                    ...
                    <div class=\"card-body\">
                        ...
                        <form role=\"form\" id=\"form_forgot\">
                            <div class=\"form-group\">
                                ...
                                <small class=\"form-text text-muted\">Ingresa la dirección de correo electrónico asociada a tu cuenta y te enviaremos un correo con las instrucciones para obtener una nueva contraseña.</small>
                            </div>
        ...
        <div class=\"row\">
            ...
            <div class=\"col-12 col-sm-10 offset-sm-1 col-md-6 offset-md-3 col-lg-4 offset-lg-4 div_form_forgot\">
                <div class=\"card bg-white border animated fadeIn z-depth-2\">
                    ...
                    <div class=\"card-footer text-center\">
                        <span class=\"text-muted\">¿Tienes cuenta?</span> <a href=\"{{config.build.url}}autenticacion\">Iniciar sesión</a><br><br>
...
{% block appFooter %}
\t<script src=\"assets/jscontrollers/autenticacion/recuperar.js\"></script>
{% endblock %}", "autenticacion/recuperar.twig", "C:\\xampp\\htdocs\\website\\app\\templates\\autenticacion\\recuperar.twig");
    }
}
