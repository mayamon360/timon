...
class __TwigTemplate_6331796c75168787d483f71208a44a52285ee0e481dbec7cf92c38e0bff0de6b extends Twig_Template
{
            ...
            <div class=\"row justify-content-md-center\">
                <div class=\"col-12 col-md-6\">
                    <div class=\"card z-depth-3\">
                        ...
                        <div class=\"card-body\">
                            <p class=\"card-text\">
                                <p>Este formulario está en construcción, muy pronto podrás realizar tus búsquedas de una forma más precisa</p>
                                <form role=\"form\" id=\"form_search\" action=\"busquedAvanzada/\" method=\"GET\">
                                    ...
                                    <div class=\"form-group\">
                                        <div class=\"input-group input-group-transparent mb-2\">
                                            <input type=\"text\" name=\"s_isbn\" id='s_isbn' class=\"form-control form-control-sm\" placeholder=\"ISBN\" autocomplete=\"off\">
                                    ...
                                    <div class=\"form-group\">
                                        <div class=\"input-group input-group-transparent mb-2\">
                                            <input type=\"text\" name=\"s_title\" id='s_title' class=\"form-control form-control-sm\" placeholder=\"Título\" autocomplete=\"off\">
                                            <div class=\"input-group-append\">
                                                <span class=\"input-group-text\">
                                    ...
                                    <div class=\"form-group\">
                                        <div class=\"input-group input-group-transparent mb-2\">
                                            <input type=\"text\" name=\"s_author\" id=\"s_author\" class=\"form-control form-control-sm\" placeholder=\"Autor\" autocomplete=\"off\">
                                            <div class=\"input-group-append\">
                                                <span class=\"input-group-text\">
                                    ...
                                    <div class=\"form-group\">
                                        <div class=\"input-group input-group-transparent mb-2\">
                                            <input type=\"text\" name=\"s_publishing\" id=\"s_publishing\" class=\"form-control form-control-sm\" placeholder=\"Editorial\" autocomplete=\"off\">
                                            <div class=\"input-group-append\">
                                                <span class=\"input-group-text\">
...
";
    ...
    {
        return array (  183 => 109,  180 => 108,  85 => 15,  82 => 14,  77 => 12,  72 => 11,  67 => 10,  62 => 9,  57 => 8,  52 => 7,  47 => 6,  40 => 4,  37 => 3,  11 => 1,);
    }
...
{% block appFooter %}
    <script src=\"assets/jscontrollers/busquedAvanzada/busqueda.js\"></script>
{% endblock %}", "busquedAvanzada/formulario.twig", "/home4/eltimonl/public_html/app/templates/busquedAvanzada/formulario.twig");
    }
}
