...
class __TwigTemplate_5d210fb8b19536cf11f77a8513349c033ab5ab29bbe29def765b96901246d859 extends Twig_Template
{
...
{% block appTitle %}
    <title>Libros de {{editorial}}</title>
    <meta name=\"title\" content=\"Libros de {{editorial}}\">
{% endblock %}
{% block appDescription %}
    <meta name=\"description\" content=\"Libros de {{editorial}}\">
{% endblock %}
{% block appKeyword %}
    <meta name=\"keyword\" content=\"Libros de {{editorial}},{{editorial}}\"> 
{% endblock %}
{% block appImage %}{% endblock %}
{% block ogTitle %}  
    <meta property=\"og:title\" content=\"Libros de {{editorial}}\">
{% endblock %}
{% block ogUrl %}
    <meta property=\"og:url\" content=\"{{config.build.url}}editorial/{{metodo}}\">
{% endblock %}
{% block ogdescription %}
    <meta property=\"og:description\" content=\"Libros de {{editorial}}\">
{% endblock %}
{% block ogImage %}
...
{% endblock %}", "editorial/editorial.twig", "/home4/eltimonl/public_html/app/templates/editorial/editorial.twig");
    }
}
