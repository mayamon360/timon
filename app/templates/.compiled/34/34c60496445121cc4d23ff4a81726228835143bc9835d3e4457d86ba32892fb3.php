...
/* libro/libro.twig */
class __TwigTemplate_db11f4724afaae0a6c52f9815f80f3af84921dc42db3ff626cf36483ffaca337 extends Twig_Template
{
...
";
    ...
    <main class=\"container-fluid\">
        ...
        // line 76
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), ($context["libro"] ?? null), "id", array()), "html", null, true);
        echo "\" class=\"btn btn-sm btn-icon boton_color\">
        ...
        // line 229
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), ($context["libro"] ?? null), "id", array()), "html", null, true);
        echo "\" class=\"btn btn-sm btn-icon boton_color comprar\">
                                <span class=\"btn-inner--text\">Comprar</span>
                                <span class=\"btn-inner--icon\"><i class=\"fas fa-shopping-bag\"></i></span>
                            </button>
                        </div>
    ...
    <main class=\"container-fluid\">
        ...
        <section class=\"container p-0 info_producto\">
            ...
            <div class=\"row\">
                ...
                <div class=\"col-12 my-2 mb-4 mb-sm-2 text-center text-sm-left animated fadeIn enlaces_relacionados\">
                ...
                <div class=\"col-12 col-sm-4 col-md-3 px-5 px-sm-3 d-none d-sm-inline animated fadeIn imagen_libro\">
                    ...
                    <img src=\"{{config.build.url}}{{libro.imagen}}\" width=\"100%\" class=\"rounded z-depth-1\">
                    ...
                    <div class=\"d-none d-sm-inline d-md-none animated fadeIn precios_acciones_libro movil\">
                        ...
                        <div class=\"row m-0 mt-3 d-flex align-items-center pb-3 acciones\">
                            ...
                            <div class=\"col-8 pr-3 pr-sm-0 pl-1 text-right\">
                                <button type=\"button\" idLibro=\"{{libro.id}}\" class=\"btn btn-sm btn-icon boton_color\">
                                    <span class=\"btn-inner--text\">Comprar</span>
                                    <span class=\"btn-inner--icon\"><i class=\"fas fa-shopping-bag\"></i></span>
                                </button>
                            </div>
                ...
                <div class=\"col-12 col-sm-8 col-md-6 pr-3 pr-sm-5 datos_libro\">
                    ...
                    <div class=\"row\">
                        ...
                        <div class=\"col-4 pr-0 d-inline d-sm-none animated fadeIn imagen_libro_movil\">
                            <img src=\"{{config.build.url}}{{libro.imagen}}\" width=\"100%\" class=\"z-depth-1 rounded\">
                        </div>
                        ...
                        <div class=\"col-8 col-sm-12 datos_generales\">
                            ...
                            <p class=\"m-0 mt-2 animated zoomInRight\">
                                ...
                                <span class=\"badge badge-dot pl-0 ml-0 ml-md-3 editorial_libro\">
                                    ...
                                    <a class=\"text-truncate pixelEditorial\" href=\"{{config.build.url}}editorial/{{ruta_editorial}}\" data-toggle=\"tooltip\" data-html=\"true\" title=\"<small><b>Ver libros de la editorial</b></small>\">
                    ...
                    {# .sinopsis #}
                    <div class=\"mt-5 text-justify animated fadeIn sinopsis\">
                        <h6>SINOPSIS:</h6>
                        <p class=\"text-justify\">
                            {{libro.descripcion|nl2br}}
                        </p>
                    </div>
                    {# /.sinopsis #}
                ...
                <div class=\"col-10 offset-1 col-sm-3 offset-sm-0 d-sm-none d-md-inline pt-3 pt-sm-0 animated fadeIn precios_acciones_libro\">
                    ...
                    <div class=\"row mt-3 d-flex align-items-center pb-3 mx-0 acciones\">
                        ...
                        <div class=\"col-8 pr-3 pr-sm-0 pl-1 text-right\">
                            <button type=\"button\" idLibro=\"{{libro.id}}\" class=\"btn btn-sm btn-icon boton_color comprar\">
                                <span class=\"btn-inner--text\">Comprar</span>
                                <span class=\"btn-inner--icon\"><i class=\"fas fa-shopping-bag\"></i></span>
                            </button>
                        </div>
...
{% endblock %}", "libro/libro.twig", "C:\\xampp\\htdocs\\website\\app\\templates\\libro\\libro.twig");
    }
}
