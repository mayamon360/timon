...
/* home/slides.twig */
class __TwigTemplate_6cc213b3b40210c96058d0333d6e9b3d9c4286928d44ecc96c981c92580c414c extends Twig_Template
{
    ...
    {
        return new Twig_Source("<section class=\"container mt-0 mt-sm-5 p-0 rounded-bottom z-depth-3\">
    <div id=\"carrusel_superior\" class=\"carousel slide carousel-fade\" data-ride=\"carousel\" data-interval=\"5000\" data-pause=\"hover\" style=\"cursor:move;\">
        <div class=\"carousel-inner rounded-top\">
                    ...
                    <div class=\"carousel-item {{s.tipo}}{{active}}\">
                        ...
                        <div class=\"container h-100 card-img-overlay contenido_carrusel\">
                            ...
                            {% if s.tipo == 'tipo_uno' or s.tipo == 'tipo_tres' %}
                                <div class=\"col-12 px-5 p-sm-0 col-sm-6 col-md-6 my-auto text-center text-sm-right\">
                                    ...
                                    <p class=\"mt-0 mt-lg-4 rounded animated {{s.animatedTexto}} descripcion_carrusel\">
                                        {{s.descripcion}}
                                    </p>
                                ...
                                <div class=\"col-5 col-sm-6 col-md-6 {{s.alignImg}} d-none d-sm-inline text-center\">
                                    <img class=\"img-fluid z-depth-4 {{s.roundedImg}} animated {{s.animatedImagen}} imagen_carrusel\" src=\"{{config.build.url}}assets/plantilla/img/slides/slide1/imagen.jpg\">
                                </div>
                            {% else %}
                                <div class=\"col-5 col-sm-6 col-md-6 {{s.alignImg}} d-none d-sm-inline text-center\">
                                    <img class=\"img-fluid z-depth-4 {{s.roundedImg}} animated {{s.animatedImagen}} imagen_carrusel\" src=\"{{config.build.url}}assets/plantilla/img/slides/slide2/imagen.jpg\">
                                </div>
                                <div class=\"col-12 px-5 p-sm-0 col-sm-6 col-md-6 my-auto text-center text-sm-left\">
                                    <h1 class=\"p-0 text-truncate animated {{s.animatedTitulo}} titulo_carrusel\">
                                        <span class=\"rounded\">{{s.titulo}}</span>
                        ...
                        {% else %}
                            {% if s.enlace != '' %}
                                <div class=\"container h-100 card-img-overlay contenido_carrusel\">
                                    <div class=\"row pb-3 align-items-end h-100\">
                                        <div class=\"col-12 px-0 pr-sm-4 text-center text-sm-right animated slideInRight\">
                                            <a href=\"{{s.enlace}}\" class=\"btn btn-sm btn-icon noSwipe z-depth-1 boton_border_color\">
                                                <span class=\"btn-inner--icon\"><i class=\"fas fa-info-circle\"></i></span>
                                                <span class=\"btn-inner--text\">Más información</span>
                                            </a>
                                        </div>
...
</section>", "home/slides.twig", "C:\\xampp\\htdocs\\website\\app\\templates\\home\\slides.twig");
    }
}
