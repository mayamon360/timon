...
/* overall/header.twig */
class __TwigTemplate_a41dc5246402545c133397e3c89cb9dd854534de066e44f532f552ac56245815 extends Twig_Template
{
            ...
            <div class=\"d-flex flex-column flex-md-row align-items-center px-0 pt-2 pb-0 py-sm-2\">
                ...
                <nav class=\"pt-3 pt-md-0 animated2 fadeIn\">
                    ...
                    {% for rs in redes_sociales %}
                        {% if rs.estatus == 'on' %}
                            <a class=\"pl-2 pr-0 pl-md-3 align-middle d-none d-md-inline-flex redSocial\" href=\"{{rs.url}}\" target=\"_blank\"><i class=\"{{rs.clase}} {{rs.estilo}} {{rs.red}}\"></i> &nbsp; {% if rs.red == 'fa-facebook-square' %} El timón librería {% endif %}</a>
                        {% endif %}
                    {% endfor %}
                </nav>
            </div>
