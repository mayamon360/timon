...
class __TwigTemplate_e456fa39335e53246825ea184905bee256626567014d21077632d6449f0ac8ea extends Twig_Template
{
...
";
    ...
    {
        return array (  162 => 69,  159 => 68,  106 => 24,  99 => 20,  95 => 19,  91 => 18,  87 => 17,  83 => 15,  80 => 14,  75 => 12,  70 => 11,  65 => 10,  60 => 9,  55 => 8,  50 => 7,  45 => 6,  40 => 4,  37 => 3,  11 => 1,);
    }
...
{% block appBody %}
    ...
    <main class=\"container mt-2 destacados mb-5\">
        ...
        <input type=\"hidden\" value=\"{{publishing}}\" id=\"publishing\">
        <div class=\"row px-0 align-items-center\">
            <div class=\"col-12 col-sm-6 col-md-7 col-lg-8\">
                <p class=\"m-0 p-0 text-muted font-weight-bold animated fadeIn\"><span class=\"coincidencias\"></span></p>
                <h1 class=\"m-0 p-0 animated fadeIn text-truncate titulo_destacado\"><i class=\"fas fa-chevron-circle-right\"></i> {{isbn}} {{title}} {{author}} {{publishing}}</h1>
\t\t\t\t<div class=\"my-1 animated fadeIn separador separador_color\"></div>
            </div>
            <div class=\"col-12 col-sm-6 col-md-5 col-lg-4 text-right pt-3 pt-md-0\">
                <div class=\"input-group input-group-sm mb-0 animated fadeIn my-auto\">
...
{% block appFooter %}
    <script src=\"assets/jscontrollers/busquedAvanzada/resultados.js\"></script>
{% endblock %}", "busquedAvanzada/resultados.twig", "/home4/eltimonl/public_html/app/templates/busquedAvanzada/resultados.twig");
    }
}
