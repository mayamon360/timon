...
class __TwigTemplate_2f0311b65b324713129d9482a41fdd70bfdc72ca33bf9527a5ea02b966865c9b extends Twig_Template
{
                            ...
                            <div class=\"row div_data_inputs\">
                                ...
                                <div class=\"col-sm-9 col-md-12 col-lg-5 pl-sm-1 pl-md-3 px-lg-1\">
                                    ...
                                    <select class=\"selectpicker state\" name=\"state\" title=\"Selecciona\" data-live-search=\"true\" data-live-search-placeholder=\"Buscar ...\">
                                        ...
                                        <option value=\"2\">Baja California (2)</option>
                                        <option value=\"3\">Baja California Sur (3)</option>
                                        <option value=\"4\">Campeche (4)</option>
                                        <option value=\"5\">Coahuila (5)</option>
                                        <option value=\"6\">Colima (6)</option>
                                        <option value=\"7\">Chiapas (7)</option>
                                        <option value=\"8\">Chihuahua (8)</option>
                                        <option value=\"9\">Ciudad de México (9)</option>
                                        <option value=\"10\">Durango (10)</option>
                                        <option value=\"11\">Guanajuato (11)</option>
                                        <option value=\"12\">Guerrero (12)</option>
                                        <option value=\"13\">Hidalgo (13)</option>
                                        <option value=\"14\">Jalisco (14)</option>
                                        <option value=\"15\">Estado de México (15)</option>
                                        <option value=\"16\">Michoacán (16)</option>
                                        <option value=\"17\">Morelos (17)</option>
                                        <option value=\"18\">Nayarit (18)</option>
                                        <option value=\"19\">Nuevo León (19)</option>
                                        <option value=\"20\">Oaxaca (20)</option>
                                        <option value=\"21\">Puebla (21)</option>
                                        <option value=\"22\">Querétaro (22)</option>
                                        <option value=\"23\">Quintana Roo (23)</option>
                                        <option value=\"24\">San Luis Potosí (24)</option>
                                        <option value=\"25\">Sinaloa (25)</option>
                                        <option value=\"26\">Sonora (26)</option>
                                        <option value=\"27\">Tabasco (27)</option>
                                        <option value=\"28\">Tamaulipas (28)</option>
                                        <option value=\"29\">Tlaxcala (29)</option>
                                        <option value=\"30\">Veracruz (30)</option>
                                        <option value=\"31\">Yucatán (31)</option>
                                        <option value=\"32\">Zacatecas (32)</option>
...
";
    ...
    {
        return new Twig_Source("", "cuenta/mis-datos.twig", "/home4/eltimonl/public_html/app/templates/cuenta/mis-datos.twig");
    }
}
