...
/* overall/header.twig */
class __TwigTemplate_b14b49621dff17eeab52f43178c54d37e6127b705fccf000a74e9d7f28197bff extends Twig_Template
{
    ...
    <section class=\"container-fluid navegacion_superior\">
        <div class=\"container px-0\">
            <div class=\"d-flex flex-column flex-md-row align-items-center px-0 pt-2 pb-0 py-sm-2\">
                ...
                <nav class=\"pt-3 pt-md-0 animated2 fadeIn\">
                    <a class=\"p-2 d-none d-md-inline\" href=\"{{config.build.url}}informacion/contacto\"><i class=\"fas fa-at\"></i> &nbsp;Contáctanos</a>
                    {% for rs in redes_sociales %}
                        {% if rs.estatus == 'on' %}
                            <a class=\"pl-2 pr-0 pl-md-3 align-middle d-none d-md-inline-flex redSocial\" href=\"{{rs.url}}\" target=\"_blank\"><i class=\"{{rs.clase}} {{rs.estilo}} {{rs.red}}\"></i> &nbsp; {% if rs.red == 'fa-facebook-square' %} Facebook {% endif %}</a>
                        {% endif %}
                    {% endfor %}
                    <a class=\"p-2 pr-0 pl-md-3 align-middle d-none d-md-inline\" href=\"{{config.build.url}}informacion/ayuda\"><i class=\"fas fa-question-circle\"></i> &nbsp;Ayuda</a>
                </nav>
            </div>
        </div>
    </section>
            ...
            <form id=\"formulario_busqueda_movil\" action=\"busqueda/\" method=\"GET\" class=\"form-inline\">
                <div class=\"form-group m-0\">
                    <div class=\"input-group\">
                        ...
                        <input type=\"search\" name=\"consulta\" class=\"form-control form-control-sm pl-0 input_buscar\" placeholder=\"Título, ISBN, editorial o autor\" autocomplete=\"off\">
                        <div class=\"input-group-btn\">
                            <a href=\"{{config.build.url}}busquedAvanzada\" class=\"btn btn-sm boton_blanco boton_buscar_left\"><i class=\"fas fa-cog\"></i></a>
                            <button class=\"btn btn-sm boton_blanco boton_buscar\" type=\"submit\">Buscar</button>
                        </div>
                    </div>
                </div>
                    ...
                    <nav class=\"navbar navbar-expand navbar-dark p-0\">
                                                ...
                                                {% for c in categorias %}
                                                    {% if c.id != 1 %}
                                                        <div class=\"col-sm-6 col-md-4 mb-3\">
                                                            <a class=\"pixelCategoria enlace_negro text-truncate\" title=\"{{c.categoria}}\" href=\"{{config.build.url}}libros/{{c.ruta}}/{{c.id}}\">
                                                                <i class=\"fas fa-angle-right mr-1 animated fadeInLeft infinite\"></i> {{c.categoria}}
                                                            </a>
                                                            <hr class=\"mt-2 mt-sm-0 mb-2\">
                                                            {% for s in subcategorias %}
                                                                {% if c.id == s.id_categoria %}
                                                                    <a class=\"dropdown-item mb-1 mb-md-0 text-truncate pixelSubcategoria\" title=\"{{s.subcategoria}}\" href=\"{{config.build.url}}libros/{{s.ruta}}/{{s.id}}\">{{s.subcategoria}}</a>
                                                                {% endif %}
                                                            {% endfor %}
                                                        </div>
                                                    {% endif %}
                        ...
                        <div class=\"ml-auto mr-3 mr-sm-0\">
                                ...
                                {% else %}
                                    <div class=\"dropdown\">
                                        ...
                                        <div class=\"dropdown-menu\" aria-labelledby=\"dropdown_user_account\" style=\"left:-168px;\">
                                            ...
                                            <a class=\"dropdown-item py-2 link_cuenta\" href=\"{{config.build.url}}cuenta/mis-compras\">
                                                <i class=\"fas fa-book-open text-app\"></i>Mis compras
                                            </a>
                            ...
                            <a href=\"{{config.build.url}}compra/\" class=\"btn btn-sm boton_blanco btn-icon ml-1 boton_compra\">
                                Mi cesta 
                                <span class=\"ml-1 btn-inner--icon\"><i class=\"fas fa-shopping-bag\"></i></span>
                                <span class=\"btn-inner--text\"><label class=\"m-0 cantidad_carrito\">({{cantidad_carrito}})</label></span>
                            </a>
                        </div>
                    </nav>
                </div>
...
</header>", "overall/header.twig", "/home4/eltimonl/public_html/app/templates/overall/header.twig");
    }
}
