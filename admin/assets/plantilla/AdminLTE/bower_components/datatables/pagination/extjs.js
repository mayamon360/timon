...
(function ($) {
	...
	var firstClassName = 'first btn btn-default btn-flat';
	var previousClassName = 'previous btn btn-default btn-flat';
	var nextClassName = 'next btn btn-default btn-flat';
	var lastClassName = 'last btn btn-default btn-flat';
	...
	$.fn.dataTableExt.oPagination.input = {
		'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
			...
			nInput.className = paginateInputClassName + ' form-control input-sm text-center';
