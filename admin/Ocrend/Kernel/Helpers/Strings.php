...
final class Strings extends \Twig_Extension {
  ...
  */
  public static function url_amigable(string $url) : string {
    $url = str_replace(['Á', 'É', 'É', 'Ó', 'Ú', 'Ñ'], ['a', 'e', 'i', 'o', 'u', 'n'], $url);
  ...
  /**
   * Limpia una expresión de texto,
   *
   * @param string $url: Cadena de texto a limpiar
   *
  ...
  */
  ...
  public function getFunctions() : array {
    return array(
      ...
      new \Twig_Function('clean_string', array($this, 'clean_string'))
    );
  }
