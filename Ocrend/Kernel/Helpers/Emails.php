...
class Emails {
     ...
     */
    public static function send(array $dest, array $content, int $template = 0, array $adj = [], $replyTo = null) : bool {
        global $config;
        ...
        # Transporte
        $transport = (new \Swift_SmtpTransport($config['mailer']['host'], $config['mailer']['port'], 'ssl'))
